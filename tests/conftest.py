...
from app.models.users import Role, User, UserCreate  # noqa: E402
...
async def beanie_init():
    ...
    await init_beanie(
        ...
        document_models=[User, UserCreate, Journal, Device, DeviceCreate],
    )
    return client
...
async def create_test_users(beanie_init, user_create_data):
    ...
    await UserCreate.insert_many(user_list)
